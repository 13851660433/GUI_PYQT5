...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(70, 470, 101, 61))
        ...
        self.pushButton_12.setGeometry(QtCore.QRect(340, 470, 101, 61))
        self.pushButton_12.setObjectName("pushButton_12")
        self.lineEdit = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit.setGeometry(QtCore.QRect(620, 60, 101, 71))
        self.lineEdit.setObjectName("lineEdit")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(40, 30, 1001, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setToolTip(_translate("MainWindow", "清空"))
        ...
        self.pushButton_12.clicked.connect(self.doAction)
    ...
    def math_text(self):
        ...
        # 开始出题
            ...
            self.lineEdit.clear()
            self.count += 1
            self.pushButton_12.setText('下一题')
    ...
    def doAction(self):
        ...
        if self.timer.isActive():
            ...
            self.pushButton_12.clicked[bool].disconnect(self.doAction)

    def timerEvent(self, e):
        if self.step >= 100 or self.count > 20:
            if self.step >= 100:
                self.Qright.information(self, 'GameOver', '时间结束\n本次游戏成绩\n答对{0}\n答错{1}'.format(self.right_text, self.wrong_text), QtWidgets.QMessageBox.Yes)
            else:
                self.Qright.information(self, 'GameOver', '恭喜您完成全部题目\n本次游戏成绩\n答对---{0}\n答错---{1}'.format(self.right_text, self.wrong_text), QtWidgets.QMessageBox.Yes)
            self.Qright.close()
            # 停止进度条
